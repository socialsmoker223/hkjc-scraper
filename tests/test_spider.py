...
class TestRateLimiting:
    """Test rate limiting functionality - REMOVED.

    Rate limiting is now handled by Scrapling's built-in mechanisms:
    - concurrent_requests_per_domain class attribute
    - download_delay class attribute
    """
